            ...
            // 1. 在判断条件中移除 type === "POUR"
                ...
                if (isV3Array) {
                    ...
                    if (mergedItem.path) {
                        ...
                        shapeData = ["R", mergedItem.x, mergedItem.y, mergedItem.width, mergedItem.height, mergedItem.rotation || 0, mergedItem.cornerRadius || 0];
                    }
                }
                ...
                if (isValidShape) {
                    ...
                    primitives.push({ 
                        id: pId, type: "POLY", net: netName, layer: layerId, 
                        shape: "POLY", vertices: vertices, 
                        x: (minX + maxX) / 2, y: (minY + maxY) / 2, 
                        w: maxX - minX, h: maxY - minY 
                    });
