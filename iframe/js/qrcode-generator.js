		...
		return (
			(f.createASCII = function (t, r) {
				...
				for (e = 0; e < a; e += 1) {
					for (o = Math.floor((e - u) / t), s = '', n = 0; n < a; n += 1)
						(i = 1), u <= n && n < c && u <= e && e < c && f.isDark(o, Math.floor((n - u) / t)) && (i = 0), (s += i ? g : l);
					for (o = 0; o < t; o += 1) h += s + '\n';
				}
			...
			(f.renderTo2dContext = function (t, r) {
				...
				for (var e = f.getModuleCount(), n = 0; n < e; n++)
					for (var o = 0; o < e; o++) (t.fillStyle = f.isDark(n, o) ? 'black' : 'white'), t.fillRect(n * r, o * r, r, r);
			}),
			f
		);
	};
			...
			return (
				(e.getRSBlocks = function (e, n) {
					...
					for (var i = o.length / 3, a = [], u = 0; u < i; u += 1)
						for (var f = o[3 * u + 0], c = o[3 * u + 1], l = o[3 * u + 2], h = 0; h < f; h += 1) a.push(r(c, l));
					return a;
				}),
				e
			);
			...
			var r = a,
				...
				n = {
					...
					write: function (t) {
						...
						n < r.length &&
							(r.length - n == 1 ? t.put(o(r.substring(n, n + 1)), 4) : r.length - n == 2 && t.put(o(r.substring(n, n + 2)), 7));
					},
				},
				o = function (t) {
							...
							a = function (t) {
									...
									h =
										...
										(g = 0),
										{
											write: function (t, r) {
												...
												for (; c + r >= 8; )
													f.writeByte(255 & ((t << c) | g)), (r -= 8 - c), (t >>>= 8 - c), (g = 0), (c = 0);
												(g |= t << c), (c += r);
											},
											flush: function () {
												c > 0 && f.writeByte(g);
								...
								for (s += 1; s < o.length; ) {
									...
									(s += 1),
										i.contains(v + d)
											? (v += d)
											: (h.write(i.indexOf(v), n), i.size() < 4095 && (i.size() == 1 << n && (n += 1), i.add(v + d)), (v = d));
								}
